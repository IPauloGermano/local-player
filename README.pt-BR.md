...
- **Whisper.cpp (opcional)**: necessário apenas para transcrição local de legendas (ver `docs/pt-br/whisper.md`).
...
| `WHISPER_BIN` / `WHISPER_MODEL_DIR` | `bin/` / `models/` | Binário e modelos do whisper (ver `docs/pt-br/whisper.md`) |
...
*Consulte o guia detalhado em `docs/pt-br/whisper.md` e `docs/pt-br/SUBTITLES.md`.*
...
- **Validação manual**: consulte `docs/pt-br/VALIDACAO.md` para o checklist completo.
...
- `docs/` — Documentação técnica em inglês (`DOCUMENTATION.md`, `SUBTITLES.md`, `whisper.md`, `VALIDATION.md`).
- `docs/pt-br/` — Documentação técnica em português (`DOCUMENTACAO.md`, `SUBTITLES.md`, `whisper.md`, `VALIDACAO.md`).
